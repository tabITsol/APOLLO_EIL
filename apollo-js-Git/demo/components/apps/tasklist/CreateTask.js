...
function CreateTask() {
    ...
    const save = () => {
        if (dialogConfig.newTask) {
            toast.current.show({ severity: 'success', summary: 'Success', detail: `Task "${task.name}" created successfully.` });
            addTask(task);
                ...
                <div className="p-4">
                    <div className="grid p-fluid formgrid">
                        ...
                        <div className="col-12 flex justify-content-end mt-4">
                            <Button className="p-button-outlined w-8rem mr-3" icon="pi pi-sync" label="Reset" onClick={() => resetTask()}></Button>
