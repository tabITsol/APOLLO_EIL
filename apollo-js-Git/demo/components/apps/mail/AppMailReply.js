...
function AppMailReply(props) {
    ...
    const sendMail = () => {
        ...
        setNewMail((prevState) => ({ ...prevState, to: from, title: title, image: image }));
        onSend(newMail);
                    ...
                    <div className="surface-section grid grid-nogutter formgrid flex-column md:flex-row gap-6 p-5 border-round">
                        <div className="col">
                            ...
                            <span className="p-input-icon-left w-full" style={{ height: '3.5rem' }}>
                                ...
                                <InputText id="to" type="text" value={newMail.from} onChange={(e) => setNewMail((prevState) => ({ ...prevState, from: e.target.value }))} className="w-full pl-7 text-900 font-semibold" style={{ height: '3.5rem' }} />
                            </span>
                        </div>
                        <div className="col">
                        ...
                        <div className="col-12 field">
                            ...
                            <Editor style={{ height: '250px' }} className="mt-3" value={newMail.message} onTextChange={(e) => setNewMail((prevState) => ({ ...prevState, message: e.htmlValue ?? '' }))}></Editor>
                        </div>
                    </div>
