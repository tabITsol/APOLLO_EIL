...
function AppMailSidebar() {
    ...
    const getBadgeValues = (data) => {
        ...
        setItems([
            { label: 'Inbox', icon: 'pi pi-inbox', badge: badgeValues.inbox, to: '/apps/mail/inbox' },
            { label: 'Starred', icon: 'pi pi-star', badge: badgeValues.starred, to: '/apps/mail/starred' },
            { label: 'Spam', icon: 'pi pi-ban', badge: badgeValues.spam, to: '/apps/mail/spam' },
            { label: 'Important', icon: 'pi pi-bookmark', badge: badgeValues.important, to: '/apps/mail/important' },
            { label: 'Sent', icon: 'pi pi-send', badge: badgeValues.sent, to: '/apps/mail/sent' },
            { label: 'Archived', icon: 'pi pi-book', badge: badgeValues.archived, to: '/apps/mail/archived' },
            { label: 'Trash', icon: 'pi pi-trash', badge: badgeValues.trash, to: '/apps/mail/trash' }
        ]);
    };
