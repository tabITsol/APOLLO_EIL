        ...
        <>
            ...
            <div className="px-5 min-h-screen flex justify-content-center align-items-center -mt-8 sm:mt-0">
                <div className="z-1 text-center">
                    ...
                    <p className="line-height-3 mt-0 mb-5 text-700 text-xl font-medium">You don&lsquo;t have the permissions to access this page</p>
                    <Button onClick={() => router.push('/')} className="p-button-help font-medium p-button-raised">
                        Go to Dashboard
                    </Button>
                </div>
            </div>
