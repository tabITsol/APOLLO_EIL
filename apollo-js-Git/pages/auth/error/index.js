        ...
        <>
            ...
            <div className="px-5 min-h-screen flex justify-content-center align-items-center">
                <div className="z-1 text-center">
                    ...
                    <p className="line-height-3 mt-0 mb-5 text-700 text-xl font-medium">Something went wrong!</p>
                    <Button onClick={() => router.push('/')} className="p-button-danger font-medium p-button-raised">
                        Go to Dashboard
                    </Button>
                </div>
            </div>
